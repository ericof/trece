...
```
DEPLOY_ENV=prod
DEPLOY_HOST=trece-ericof.tangrama.com.br
DEPLOY_PORT=22
DEPLOY_USER=plone
...
prod:
  hosts:
    trece-ericof.tangrama.com.br:
      ansible_user: root
      host: trece-ericof
      hostname: trece-ericof.tangrama.com.br
```
...
Deploy the stack defined in `devops/stacks/trece-ericof.tangrama.com.br.yml` to the remote server with:
